...
import { Container, VStack, Box, Alert, Heading, Flex, Avatar, Text, Button, Spinner, AlertIcon } from '@chakra-ui/react'
import { startDateFormat, endDateFormat, daysLeftUntilEvent, daysLeftInEvent, eventBeforeStartDate, eventAfterEndDate } from '../helper/eventData'
      ...
      {Object.keys(eventData).length ?
        <>
          <Flex zIndex='0' p='0' mt='10' name="wrapper" mb='10' direction={{ base: 'column', md: 'row' }}>
            ...
            <Flex display='flex' flexDirection='column' width={{ base: '100%', md: '50%' }} name="widget">
            ...
            <Box width='100%' zIndex='-1' position='absolute' top='0' left='0' bgGradient='linear(to-b, third, second)' height={{ base: '650px', md: '100vh' }}>
