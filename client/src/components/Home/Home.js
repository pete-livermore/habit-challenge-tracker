            ...
            <Flex name='discover-container' alignItems='center' w='100%' justify='space-between' flexDirection={{ base: 'column', md: 'row', lg: 'row' }} flexWrap='wrap' mt='4' mb='6'>
              <>
                {events.map(event => {
                  ...
                  return (
                    <Flex name="actions" p='4' mt='5' bgGradient='linear(to-r, white, gray.100)' width='300px' minHeight='300px' flexDirection='column' borderWidth='1px' alignItems='center' justifyContent='space-between' boxShadow='2xl' borderRadius='10'>
                       <Link to={`/events/${_id}`}>
